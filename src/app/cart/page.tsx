...
import CheckOutSession from '@/app/_components/CheckOutSession/CheckOutSession'
...
export default function Cart() {
  ...
  return (
    ...
    <div className="mb-6 p-8 bg-gray-50 rounded-full">
      <ShoppingCartIcon size={80} className="text-gray-300 stroke-[1.5]" />
    </div>
    ...
    <p className="text-gray-500 max-w-sm mb-8 text-lg">
      Looks like you have not added anything to your cart yet. Explore our categories and start shopping!
    </p>

    <Link href='/products'>
      <Button className='bg-black hover:bg-black text-white px-10 py-6 rounded-2xl text-lg font-bold shadow-lg shadow-blue-100 transition-all hover:scale-105 active:scale-95'>
        Start Shopping
      </Button>
    </Link>
  </div>
