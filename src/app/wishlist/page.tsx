...
export default function Wishlist() {
  ...
  <div className="mb-6 p-8 bg-red-600 rounded-full">
    <Heart size={70} className="text-white stroke-[1.5] animate-pulse" />
  </div>
  ...
  <p className="text-gray-500 max-w-sm mb-8 text-lg">
    Save your favorite items here to keep an eye on them. You haven't added anything yet!
  </p>

  <Link href='/products'>
    <Button className='bg-gray-900 hover:bg-black text-white px-10 py-6 rounded-2xl text-lg font-bold shadow-lg transition-all hover:scale-105 active:scale-95'>
      Explore Products
    </Button>
  </Link>
</div>
